...
<div class="modal container fade" id="article-detail" aria-hidden="false">
    <div class="modal-content">
        <div class="modal-body">
            ...
            <div class="row portlet light portlet-fit">
                <!-- Information -->
                        ...
                        <fieldset class="fieldset">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4 text-left">
                                    <a name="form-edit" data-name="id"></a>
                                </div>
                                <div class="col-md-2 text-right">
                                    <span>Author Namee:</span>
                                </div>
                                <div class="col-md-4 text-left">
                                    <a href="#" name="form-edit" data-name="user_id" data-type="select"></a>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="col-md-2 text-right">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4 text-left">
                                    <a href="#" name="form-edit" data-name="create_time" data-type="date"></a>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 margint-10">
                                ...
                                <div class="input-daterange input-group">
                                    <a href="#" name="form-edit" data-name="content" data-type="textarea"></a>
                                </div>
                            </div>
                            <div class="col-md-12 margint-10 marginb-20">
...
<div id="dialog-confirm" class="modal fade" data-backdrop="static" data-keyboard="false" data-attention-animation="false">
    <div class="modal-body">
        <p ng-bind="confirmInfo.title"></p>
    </div>
    <div class="modal-footer">
        <button type="button" data-dismiss="modal" class="btn btn-outline red">Cancel</button>
        <button type="submit" ng-click="doConfirm()" class="btn green">Confirm</button>
    </div>
</div>
